            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="mb-6 flex justify-between items-center">
                    ...
                    <div class="relative w-64">
                        ...
                        <button @click="$inertia.get(route('stocks.index'), { search })"
                            class="absolute right-2 top-2 text-white-400 hover:text-white-600">
                ...
                <div class="border border-gray-800 bg-default text-white shadow-sm overflow-hidden sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="border border-gray-800 bg-default text-white shadow-sm divide-y divide-gray-200">
                            <tr v-for="stock in stocks" :key="stock.symbol">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-white-900">
                                        {{ stock.longName || stock.shortName || stock.displayName || 'N/A' }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-white-900">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div :class="{
                                        'text-green-600': stock.regularMarketChange >= 0,
                                        'text-red-600': stock.regularMarketChange < 0,
                                    }">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div :class="{
                                        'text-green-600': stock.regularMarketChangePercent >= 0,
                                        'text-red-600': stock.regularMarketChangePercent < 0,
                                    }">
                            ...
                            <tr v-if="stocks.length === 0">
                                <td colspan="5" class="px-6 py-4 text-center text-white-500">No stocks found</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
